...
public class Database {
 ...
 batch.setCode(batches.getString(batches.getColumnIndex(Database.BATCHES_BATCHCODE)));
...
cls.setClassId( classes.getString( classes.getColumnIndex(Database.CLASSES_CLASSES_ID)));
	...
	public static boolean addClass(Context context, String batchCode, String classDate, 
     String classTime, String period, String topics, String remarks, boolean adjust) {
